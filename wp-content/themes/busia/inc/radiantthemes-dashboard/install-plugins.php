...
<div class="wrap about-wrap rt-admin-wrap">
	<h1><?php echo esc_html__( 'Welcome to ', 'busia' ) . $busia_my_theme->Name; ?></h1>
	...
	<h2 class="nav-tab-wrapper wp-clearfix">
		<a class="nav-tab" href="<?php echo esc_url( self_admin_url( 'themes.php?page=radiantthemes-dashboard' ) ); ?>"><?php esc_html_e( 'Dashboard', 'busia' ); ?></a>
		<a class="nav-tab nav-tab-active" href="<?php echo esc_url( self_admin_url( 'themes.php?page=radiantthemes-admin-plugins' ) ); ?>"><?php esc_html_e( 'Install Plugins', 'busia' ); ?></a>
		...
		<div class="welcome-content w-clearfix extra">
			<div class="radiantthemes-plugins radiantthemes-theme-browser-wrap">
				<div class="theme-browser rendered">
					<div class="whi-install-plugins-wrap">
						<h3><?php echo esc_html__( 'These below plugins are required', 'busia' ); ?></h3>
						<a href="#" class="radiantthemes-admin-btn whi-install-plugins"><?php echo esc_html__( 'Activate all plugins', 'busia' ); ?></a>
					</div>
					...
					foreach ( $plugins as $plugin ) :
						...
						if ( strpos( $plugin_action, 'deactivate' ) !== false ) {
							...
							$plugin_action = '<div class="row-actions visible active"><span class="activate"><a class="button radiantthemes-admin-btn">' . esc_html__( 'Activated', 'busia' ) . '</a></span></div>';
						}
						?>
			...
			<?php if ( defined( 'FW' )  ) : ?>
				<div class="radiantthemes-notice radiantthemes-notice-success plugin-install-success" >
					<p><a href="<?php echo esc_url( self_admin_url( 'tools.php?page=fw-backups-demo-content' ) ); ?>"><?php echo esc_html__( 'Click Here to continue with Demo Import process.', 'busia' ); ?></a></p>
				</div>
			<?php endif; ?>
		</div>
	</div>
