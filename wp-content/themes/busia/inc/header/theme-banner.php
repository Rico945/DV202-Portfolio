...
<?php } elseif ( is_front_page() ) { ?>
	...
	<?php } ?>
		...
		if (
			...
			( 'Banner-only' === get_theme_mod( 'short-header' ) )
		) {
			?>
			<!-- wraper_inner_banner_main -->
		...
		<!-- wraper_header_bannerinner -->
<?php } elseif ( is_home() ) { ?>
	<?php if ( 'banner-none' !== get_theme_mod( 'short-header' ) ) { ?>
		<!-- wraper_header_bannerinner -->
...
<?php } elseif ( is_search() ) { ?>
	<?php if ( 'banner-none' !== get_theme_mod( 'short-header' ) ) { ?>
		...
		if ( get_theme_mod( 'search_page_bg' ) ) {
			...
			?>
		<div class="wraper_inner_banner search-theme-banner" style="background-image:url('<?php echo esc_url( $search_page_banner_image_link ); ?>')">
		<?php } else { ?>
			<div class="wraper_inner_banner search-theme-banner">
		<?php } ?>
			<?php
			if (
			( 'Banner-With-Breadcrumb' === get_theme_mod( 'short-header' ) ) ||
