		...
		<div class="row">
			...
			<?php } else { ?>
				<?php if ( 'leftsidebar' === get_theme_mod( 'blog-layout' ) ) { ?>
					<?php if ( 'three-grid' === get_theme_mod( 'blog-layout-sidebar-width' ) ) { ?>
						<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 order-lg-12 order-sm-12">
					<?php } elseif ( 'four-grid' === get_theme_mod( 'blog-layout-sidebar-width' ) ) { ?>
						<div class="col-lg-8 col-md-7 col-sm-12 col-xs-12 order-lg-12 order-sm-12">
					<?php } elseif ( 'five-grid' === get_theme_mod( 'blog-layout-sidebar-width' ) ) { ?>
