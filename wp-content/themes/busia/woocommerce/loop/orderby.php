...
<form class="woocommerce-ordering" method="get">
	<select name="orderby" class="orderby" aria-label="<?php esc_attr_e( 'Shop order', 'busia' ); ?>">
...
<div class="rt-display-view">
	<button  id="rt-shop-display-grid" class="rt-shop-display-grid <?php if ( 'shop-style-four-column' === get_theme_mod( 'shop-style', '', false ) || ! class_exists( 'Redux' ) ) { echo "active" ;}?>">
	...
	<button  id="rt-shop-display-small-grid" class="rt-shop-display-small-grid <?php if ( 'shop-style-five-column' === get_theme_mod( 'shop-style', '', false ) ) { echo "active" ;}?>">
		<svg width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<?php if ( 'shop-topsidebar' === get_theme_mod( 'shop-sidebar', '', false )  ){ ?>
		<button  id="rt-shop-display-verysmall-grid" class="rt-shop-display-vertsmall-grid <?php if ( 'shop-style-six-column' === get_theme_mod( 'shop-style', '', false ) ) { echo "active" ;}?>">
