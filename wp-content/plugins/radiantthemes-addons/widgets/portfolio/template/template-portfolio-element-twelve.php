...
$output .= '<div class="rt-portfolio-box element-twelve row">';
// WP_Query arguments.
global $wp_query;
$args     = array(
	'post_type'      => 'portfolio',
...
if ( $my_query->have_posts() ) {
	while ( $my_query->have_posts() ) :
		...
		if ( '2' == $settings['radiant_portfolio_row_posts'] ) {
			$output .= '<div class="rt-portfolio-box-item col-lg-6 col-md-6 col-sm-6 col-xs-12  wow rollIn ';
		} elseif ( '3' == $settings['radiant_portfolio_row_posts'] ) {
			$output .= '<div class="rt-portfolio-box-item col-lg-4 col-md-4 col-sm-6 col-xs-12  wow rollIn ';
		} elseif ( '4' == $settings['radiant_portfolio_row_posts'] ) {
			$output .= '<div class="rt-portfolio-box-item col-lg-3 col-md-3 col-sm-6 col-xs-12  wow rollIn ';
		}
		if ( $terms ) {
