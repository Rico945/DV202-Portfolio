...
class Radiantthemes_Style_Portfolio extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options'     => array(
					...
					'four'      => esc_html__( 'Color Overlay with Icon (Masonry)', 'radiantthemes-addons' ),
					'eight'     => esc_html__( 'Full Width with Icon  (Box)', 'radiantthemes-addons' ),
					'ten'       => esc_html__( 'Boxed Content (Small Data Box)', 'radiantthemes-addons' ),
					'twelve'    => esc_html__( 'Classic Masonry  (Masonry)', 'radiantthemes-addons' ),
					'thirteen'  => esc_html__( 'Thirteen', 'radiantthemes-addons' ),
					'metro'  => esc_html__( 'Metro', 'radiantthemes-addons' ),
				),
				'default'     => 'eight',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'options'     => array(
					'2' => esc_html__( 'Two', 'radiantthemes-addons' ),
					'3' => esc_html__( 'Three', 'radiantthemes-addons' ),
					'4' => esc_html__( 'Four', 'radiantthemes-addons' ),
				),
				'default'     => '3',
				'condition'   => array(
		...
		$this->add_control(
			...
			array(
				...
				'selectors'   => array(
					...
					'{{WRAPPER}} .rt-portfolio-box.rt-port-metro .rt-portfolio-box-item .rt-portfolio-box-content' => 'background-color: {{VALUE}}',
				),
				'default'     => '#000000',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				{{WRAPPER}} .rt-portfolio-box .rt-portfolio-box-item >  .data .title a , .rt-portfolio-box.element-seventeen .rt-portfolio-box-item .text-holder .text-wrapper .content-text .content-entry-title , .element-eightteen .rt-portfolio-box-item .holder .text-holder .text-wrapper .content-text .content-entry-title,{{WRAPPER}} .rt-portfolio-box.rt-port-metro .rt-portfolio-box-item .rt-portfolio-box-content .portfolio-title',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .rt-portfolio-box.rt-port-metro .rt-portfolio-box-item .rt-portfolio-box-content .portfolio-title' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
			...
			array(
				...
				{{WRAPPER}} .rt-portfolio-box .rt-portfolio-box-item > .data .categories span , .rt-portfolio-box.element-seventeen .rt-portfolio-box-item .text-holder .text-wrapper .content-text .content-category , .element-eightteen .rt-portfolio-box-item .holder .text-holder .text-wrapper .content-text .content-category, {{WRAPPER}} .rt-portfolio-box.rt-port-metro .rt-portfolio-box-item:hover .rt-portfolio-box-content .portfolio-category',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .rt-portfolio-box.rt-port-metro .rt-portfolio-box-item:hover .rt-portfolio-box-content .portfolio-category' => 'color: {{VALUE}}',
	...
	protected function render() {
		...
		if ( '3' == $settings['radiant_portfolio_row_posts'] ) {
				$class = 'col-lg-4 col-md-4 col-sm-4 col-xs-12';
		} elseif ( '4' == $settings['radiant_portfolio_row_posts'] ) {
