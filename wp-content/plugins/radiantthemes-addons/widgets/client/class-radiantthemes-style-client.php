...
class Radiantthemes_Style_Client extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'four'  => esc_html__( 'Style Four (Boxed Bordered)', 'radiantthemes-addons' ),                    'five'  => esc_html__( 'Style Five', 'radiantthemes-addons' ),
	...
	protected function render() {
		...
		if ( 'false' === $settings['clients_allow_carousel'] ) {
			...
			if ( 'true' === $settings['allow_autoplay'] ) {

			$output = '<div class="clients swiper-container allow-autoplay element-' . esc_attr( $settings['clients_style'] ) . '"';
             $output .= ' data-mobile-items="';
			$output .= $settings['posts_in_mobile'] . '" data-tab-items="';
			$output .= $settings['posts_in_tab'] . '" data-desktop-items="';
			$output .= $settings['posts_in_desktop'] . '" data-spacer="'.$settings['space_between_posts'] . '" data-autoplay="'.$settings['allow_autoplay'] . '">';
			$output .= '<div class="swiper-wrapper">';
			} else {
				$output = '<div class="clients swiper-container notallow-autoplay element-' . esc_attr( $settings['clients_style'] ) . '"';
             $output .= ' data-mobile-items="';
			$output .= $settings['posts_in_mobile'] . '" data-tab-items="';
			$output .= $settings['posts_in_tab'] . '" data-desktop-items="';
			$output .= $settings['posts_in_desktop'] . '" data-spacer="'.$settings['space_between_posts'] . '" data-autoplay="'.$settings['allow_autoplay'] . '">';
	...
	$clients_category = array(
		...
		if ( $query->have_posts() ) {
			while ( $query->have_posts() ) {
				...
				//$output .= '<div style="border-top:'.the_field('border_top').';  border-right:'.the_field('border_right').';  border-bottom:'.the_field('border_bottom').';  border-left:'.the_field('border_left').' ;">';
