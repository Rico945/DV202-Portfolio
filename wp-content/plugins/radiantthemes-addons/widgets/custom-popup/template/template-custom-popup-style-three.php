<?php
/**
 * Custom Popup  Template Style Three
 *
                ...
                $output .= ' <div class="rt-modal-style-btn">';
                     $output .= '<div class="rtbtn-content-item">';
                        ...
                        $output .= ' <div class="modal-element-' . esc_attr( $settings['radiant_custom_popup_style'] ) . '  modal-element">';
                            $output .= ' <button class="rtbtn-content-button rtbtn-content-button-modal gradient-color button" id="two"><span><span>' . esc_attr( $settings['radiant_custom_popup_btn_text'] ) . '</span></span></button>';
                        $output .= ' </div>';
