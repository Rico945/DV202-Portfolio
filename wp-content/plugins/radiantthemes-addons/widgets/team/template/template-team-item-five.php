 ...
 */
 ...
 $output .= '<section class="col-lg-4 col-md-6 col-sm-6 col-xs-12">';
 }
    
                    $output .= '<div class="rt-team_box row">
                        <div class="rt-thumbnailsm col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        ...
                        <div class="rt-team_box-info col-lg-2 col-md-2 col-sm-2 col-xs-2">';
               ...
               $output .= '<h6>' . $term->name . '</h6>';
                            ...
                            $output .= '<a href="' . get_the_permalink() . '"><h4 class="wobble" data-animation="sheen">' . get_the_title() . '</h4></a>
                        </div>
